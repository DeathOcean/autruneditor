@echo off
set version=2.0
title Autorun Editor - V %version%
:hm
cls
...
echo       d88888          888                                       
echo      d88P888          888                                       
echo     d88P 888 888  888 888888  .d88b.  888d888 888  888 88888b.  
echo    d88P  888 888  888 888    d88""88b 888P"   888  888 888 "88b 
echo   d88P   888 888  888 888    888  888 888     888  888 888  888 
echo  d8888888888 Y88b 888 Y88b.  Y88..88P 888     Y88b 888 888  888 
echo d88P     888  "Y88888  "Y888  "Y88P"  888      "Y88888 888  888
echo.
echo.
echo 							#######                              
echo 							#       #####  # #####  ####  #####  
...
if %press%==3 goto help
if %press%==4 goto exit
if %press%==! goto autoruneditor
if %press%==" goto soon
if %press%==§ goto help
if %press%==$ goto exit
